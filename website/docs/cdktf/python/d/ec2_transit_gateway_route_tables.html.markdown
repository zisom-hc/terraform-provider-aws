...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_ec2_transit_gateway_route_tables_example =
        aws.data_aws_ec2_transit_gateway_route_tables.DataAwsEc2TransitGatewayRouteTables(self, "example")
        cdktf_terraform_output_example = cdktf.TerraformOutput(self, "example_1",
            value=data_aws_ec2_transit_gateway_route_tables_example.ids
        )
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-fa24fd98c9be593f3667314adc167d04b2c5bf98200d7aac02439eaf959c3671 -->